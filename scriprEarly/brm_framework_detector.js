                        ...
                        await waitForUserResponse({
							...
							html: `
								檢測到<span class="orange">秋枫白桦框架模组</span><span class="red">版本過低</span>。為保證<span style="
									...
									color: transparent;
								">Bailey rent mod</span>所有功能正常，建議將其更新至v2.4.3版本或以上。<br>
								<br>
                        ...
                        await waitForUserResponse({
							...
							html: `
								檢測到<span class="orange">秋枫白桦框架模组</span><span class="red">版本過低</span>。為保證<span style="
									...
									-webkit-background-clip: text;
									color: transparent;
								">Bailey rent mod</span>所有功能正常，建議將其更新至v2.0.5版本或以上。<br>
								<br>
                    ...
                    await waitForUserResponse({
						...
						html: `
							檢測到<span class="red">沒有載入</span><span class="orange">秋枫白桦框架模组</span>或<span class="yellow">简易框架模组</span>，而<span style="
								...
								-webkit-background-clip: text;
								color: transparent;
							">Bailey rent mod</span>多數功能需要安裝任一框架才能正常運作（請不要同時安裝兩個框架以避免嚴重衝突）<br>
							<br>
